  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center w-full z-10 gap-12">
        ...
        {/* Right Content - Responsive 3D/Visual */}
        <div className="w-full md:w-2/5 h-[300px] md:h-[600px] flex items-center justify-center relative mt-8 md:mt-0">
          <div className="relative w-[280px] sm:w-[300px] md:w-[500px] h-[280px] sm:h-[300px] md:h-[500px] flex items-center justify-center perspective-container">
